...
$(document).ready(function () {
  ...
  function removeFromHistory(selectedCity) {
    ...
    //if the current city is not the city that I have selected to delete
    //add the current city to a new array    
  ...
  function makeRow(text) {
    ...
    let delButton = $("<button>").attr("class", "col-2 btn btn-danger btn-sm deleteBtn")
      .attr("data-city", text).text("Delete");
  ...
  function buildFiveDayWeatherDOM(weatherData) {
    ...
    for (weatherData of weatherData.list) {
